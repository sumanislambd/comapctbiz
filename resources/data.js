export default {
  ...
  spendingsLastMonth: [
    {"number": 10, "name": 'Credit Card Debt'},
    {"number": 7, "name": 'Existing Debt'},
    {"number": 16, "name": 'Capital'},
    {"number": 23, "name": 'Acc/Receivable'},
    {"number": 42, "name": 'Profitability'},
    {"number":  4, "name": 'Bankruptcy'},
  ],
};
